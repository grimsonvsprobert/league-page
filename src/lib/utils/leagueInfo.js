/*   STEP 1   */
export const leagueID = "1048198408441315328"; // your league ID
export const leagueName = "Don’t Touchdown There"; // your league name
...
export const managers = [
     {
      ...
      // "fantasyStart": 2014,  (optional) when did the manager start playing fantasy football
       ...
       "philosophy": "quinn give me something to put here",
    //   "tradingScale": 10,  1 - 10
    //   "preferredContact": "Sleerp",  'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
     },
